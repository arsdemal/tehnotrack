 ...
 *
 */
public class NewNioServer implements Runnable {
    ...
    public NewNioServer(InetAddress hostAddress, int port) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            new Thread(new NewNioServer(null, 9090)).start();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
